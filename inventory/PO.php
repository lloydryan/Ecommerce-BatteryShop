...
<div id="product-container">
    ...
    <div class="product-row mb-3">
        <div class="mb-3">
            <label class="PO_label" for="product">Product:</label>
            <select name="product[]" class="form-control" required>
                ...
                ?>
                    ...
                    <div class="mb-3">
                        <label class="PO_label" for="quantity">Quantity:</label>
        ...
        <?php
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                $sql = "INSERT INTO purchase_order (supplier_Id, employee_ID, order_date) 
                        VALUES ('$supplier_Id', '$userID', NOW())"; // Insert the userID
