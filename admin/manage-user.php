                                            ...
                                            <table class="table table-striped mb-0">
                                                <thead style="background-color: #0275d8; ">
                                                    <tr>
                                                        <center>
                                                            ...
                                                            <th class="text-center" scope="col">Email Account</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <a href="update-user.php?updateid=<?php echo $row['ID']; ?>">Edit <i
                                                                    class="fa-solid fa-pen-to-square fa-xl"></i></a>
                                                        <a style="color:red;"    href="#" 
                                                                onclick="confirmDelete(<?php echo $row['ID']; ?>)">Delete <i
...
<script>
    document.getElementById("addCustomerBtn").addEventListener("click", function () {
        window.location.href = "add-user.php"; // Replace "add-customer.php" with the actual URL of your add customer page
    });
</script>
...
<!-- Place this script tag in your HTML's <head> section -->
